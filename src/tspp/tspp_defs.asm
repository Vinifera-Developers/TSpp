...
ASM_DEFINE_IMPLEMENTATION ??0VoxelLibraryClass@@QAE@AAVFileClass@@_N@Z 00667E70h
...
ASM_DEFINE_IMPLEMENTATION ??0MotionLibraryClass@@QAE@AAVFileClass@@@Z 00561CA0h
