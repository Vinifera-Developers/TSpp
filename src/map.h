...
class MapClass : public GScreenClass
{
    ...
    public:
        ...
        // 00516060
        // 005160F0
        Cell Nearby_Location(Cell &cell, SpeedType speed, int zone = -1, MZoneType check = MZONE_NORMAL, bool check_flagged = false, int width = 1, int height = 1, bool a8 = false, bool a9 = false, bool a10 = false, bool a11 = true, Cell &a12 = INVALID_CELL) const;
