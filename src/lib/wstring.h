...
/*******************************************************************************
 *  @brief  A base implementation for dealing with strings without directly
 *          interacting with c-style character arrays.
 *
...
public:
    ...
    const char& operator[](int index) const { return Get_Char(index); }
