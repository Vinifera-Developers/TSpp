...
public:
    ...
    int Get_Char_Count() const { return Info_Block_Ptr()->NumChars; }

    int Get_Font_Width() const { return Info_Block_Ptr()->MaxWidth; }

    int Get_Font_Height() const { return Info_Block_Ptr()->MaxHeight; }
