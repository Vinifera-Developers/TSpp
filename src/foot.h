...
class FootClass : public TechnoClass
{
    ...
    public:
        ...
        virtual void Draw_Voxel(VoxelObject &voxeldata, unsigned int frame, int key, VoxelIndex &index, Rect &rect, Point2D &point, Matrix3D &matrix, int color, int flags) const override;
