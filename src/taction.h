...
TActionClass : public AbstractClass
{
    ...
    public:
        ...
        bool TAction_Set_Team_ID(HouseClass *house, ObjectClass *object, TriggerClass *trigger, Cell &cell);
        ...
        bool TAction_Grow_Shroud(HouseClass *house, ObjectClass *object, TriggerClass *trigger, Cell &cell);
        bool TAction_Set_Global(HouseClass *house, ObjectClass *object, TriggerClass *trigger, Cell &cell);
        bool TAction_Clear_Global(HouseClass *house, ObjectClass *object, TriggerClass *trigger, Cell &cell);
        ...
        bool TAction_Timer_Extend(HouseClass *house, ObjectClass *object, TriggerClass *trigger, Cell &cell);
        bool TAction_Timer_Shorten(HouseClass *house, ObjectClass *object, TriggerClass *trigger, Cell &cell);
        bool TAction_Timer_Set(HouseClass *house, ObjectClass *object, TriggerClass *trigger, Cell &cell);
        ...
        bool TAction_Place_Drop_Zone_Flare(HouseClass *house, ObjectClass *object, TriggerClass *trigger, Cell &cell);
        ...
        bool TAction_All_To_Hunt(HouseClass *house, ObjectClass *object, TriggerClass *trigger, Cell &cell);
